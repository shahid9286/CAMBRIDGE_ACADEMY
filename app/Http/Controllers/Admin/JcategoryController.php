...
class JcategoryController extends Controller
{
    ...
    public function jcategory (Request $request){
        ...
        return view('admin.job.job_category.index', compact('jcategories'));
    }


    public function add(){

        return view('admin.job.job_category.add');
    }
    ...
    public function edit($id){
        ...
        return view('admin.job.job_category.edit', compact('jcategory'));
