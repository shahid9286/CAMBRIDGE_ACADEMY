...
'icon' => 'nullable',
        ...
        if ($request->hasFile('icon')) {
            ...
            $file->move(public_path('assets/admin/uploads/icons'), $filename);
            $why_choose_us->icon = 'assets/admin/uploads/icons/' . $filename;
        }
    ...
    public function delete($id)
    {
        ...
        unlink(public_path($why_choose_us->icon));
...
if ($request->hasFile('icon')) {
    ...
    if ($why_choose_us->icon && file_exists(public_path($why_choose_us->icon))) {
        unlink(public_path($why_choose_us->icon));
    }
    ...
    return redirect()->route('admin.why-choose-us.index', $why_choose_us->page->slug)
