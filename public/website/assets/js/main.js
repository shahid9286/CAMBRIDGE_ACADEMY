...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        const bannerFade = new Swiper(".banner-fade", {
           ...
           autoplay: {
        delay: 3500, // stays 5 seconds before switching
        disableOnInteraction: false,
    },
    speed: 1500, // transition takes 1.5 seconds
        ...
        const visaCourseCarousel = new Swiper(".visa-course-carousel", {
            // Optional parameters
            loop: true,
            freeMode: true,
            grabCursor: true,
        ...
        /* ==================================================
         ...
         ===============================================*/
        const countrCoverageCarousel = new Swiper(
            ".country-coverage-carousel",
            {
                // Optional parameters
                loop: true,
                freeMode: true,
        ...
        /* ==================================================
         ...
         ===============================================*/
        const testimonialOneCarousel = new Swiper(
        ...
        /* ==================================================
         ...
         ===============================================*/
        const tesimonialThreeCarousel = new Swiper(
        ...
        /* ==================================================
         ...
         ===============================================*/
        const tesimonialFourCarousel = new Swiper(
            ".testimonial-four-carousel",
            {
                // Optional parameters
                loop: true,
		...
		* ================================================================= */
        ...
        $(".country-three-content-list .item").on("click", function (e) {
            ...
            $(".country-three-contents:nth-child(" + selectedIndex + ")")
                .addClass("active")
                .siblings()
                .removeClass("active");
        });
