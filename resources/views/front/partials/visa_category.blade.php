                            ...
                            @foreach ($page_categories as $page_category)
                                <div class="swiper-slide">
                                    <div class="visa-cat-style-one">
                                        <div class="thumb">
                                            <img src="{{ asset($page_category->image) }}" alt="Image Not Found">
                                            <div class="shape">
                                                <img src="{{ asset('front/assets/img/shape/39.png') }}"
                                                    alt="Image Not Found">
                                            </div>
                                            <div class="icon">
                                                <img src="{{ asset($page_category->icon) }}" alt="Image Not Found">
                                            </div>
                                        </div>
                                        <div class="info">
                                            <h4><a href="{{ route('front.category-wise-pages', ['slug' => $page_category->slug]) }}">{{ $page_category->title }}</a></h4>
                                            <p>
                                                {!! $page_category->description ?? '' !!}
                                            </p>
                                        </div>
                                        <div class="button">
                                            <a href="{{ route('front.category-wise-pages', ['slug' => $page_category->slug]) }}">
                                                <i class="fas fa-angle-right"></i>
                                                <span>Detail</span>
                                                <div class="shape"><img
                                                        src="{{ asset('front/assets/img/shape/40.png') }}"
