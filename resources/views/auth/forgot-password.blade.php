...
<body class="login-page" style="min-height: 496.781px;" cz-shortcut-listen="true">
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ $setting->logo ? asset($setting->logo) : asset('logo.png') }}" width="300px">
        </div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group">
                            <input id="email" type="email"
                                class="form-control rounded-left @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus required>
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <button type="submit"
                                class="form-control btn btn-primary rounded submit px-3">Send Password Reset Link</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script src="{{ asset('assets/admin/auth/js/jquery.min.js') }}"></script>
<script src="{{ asset('assets/admin/auth/js/popper.js') }}"></script>
