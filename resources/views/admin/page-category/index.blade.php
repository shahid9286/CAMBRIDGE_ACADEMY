            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline mt-3">
                    <div class="card-header">
                        <h3 class="card-title mt-1"><b>{{ __('List of Page Categories') }}</b></h3>
                        <div class="card-tools d-flex">
                            <a href="{{ route('admin.page_category.add') }}" class="btn btn-primary btn-sm mx-1">
                    ...
                    <div class="card-body">
                        <div class="tableContent">
                            <table class="table table-striped table-bordered table-sm text-center data_table">
                                ...
                                <tbody id="tbody">
                                    @forelse ($page_categories as $id => $page)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <!-- Edit Button -->
                                                 <a href="{{ route('admin.page_category.edit', ['id' => $page->id]) }}" class="btn btn-sm btn-primary mx-1"><i class="fas fa-edit"></i>Edit</a> 
                                                <!-- Details Button -->
                                                <!-- <a href="{{ route('admin.page_category.edit', ['id' => $page->id]) }}" class="btn btn-warning btn-sm mx-1 px-2"><i class="fas fa-info"></i> </a> -->
                                                <!-- Delete Button -->
                                                {{-- <form id="deleteform" class="d-inline-block mx-1" action="{{ route(''admin.page_category.delete, $page->id) }}" method="post">
                                                    @csrf
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="10" class="text-center text-muted">No Category available.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
