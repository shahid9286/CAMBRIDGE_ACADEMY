...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ __('Edit Blog Category') }} </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.bcategory.update', $bcategory->id) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="{{ ($bcategory->name)}}">
                            ...
                            <div class="form-group row">
                                <label for="order_no" class="col-sm-2 control-label">{{ __('Order No') }}<span
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" name="serial_number" id="order_no"
                                        placeholder="{{ __('Enter Order Number') }}" value="{{ $bcategory->serial_number }}"></div>
