...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ __('Add Blog') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Add Blog') }}</h3>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.blog.store') }}" method="POST"
                                ...
                                <div class="form-group row">
                                    <label for="keywordsinput" class="col-sm-2 control-label">{{ __('Meta Keywords') }}</label>
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control" name="meta_keywords" id="keywordsinput" placeholder="Enter Meta Keywords"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control form-control-sm" name="meta_description" id="meta_description" placeholder="{{ __('Meta Description') }}"
