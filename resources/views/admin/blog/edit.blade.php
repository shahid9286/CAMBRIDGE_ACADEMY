                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.blog.update', $blog->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" placeholder="{{ __('Enter Title') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="content" class="form-control summernote" id="content" placeholder="Enter Content" rows="6">{{ $blog->content }}</textarea>
                            ...
                            <div class="form-group row">
                                <label for="keywordsinput" class="col-sm-2 control-label">{{ __('Meta Keywords') }}
                                </label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" id="keywordsinput" placeholder="Enter Meta Keywords"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" name="meta_description" id="meta_description" placeholder="{{ __('Enter Meta Description') }}" rows="4">{{ $blog->meta_description }}</textarea>
                                    </div>
