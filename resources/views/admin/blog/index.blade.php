                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <table id="idtable" class="table table-bordered table-striped data_table">
                            <thead>
                                <tr>
                                    <th><input type="checkbox" data-target="blog-bulk-delete" class="bulk_all_delete">
                                    </th>
                                    <th>{{ __('Image') }}</th>
                                    <th>{{ __('Title') }}</th>
                                    <th>{{ __('Category') }}</th>
                            ...
                            <tbody>
                                ...
                                <tr id="blog-bulk-delete">
                                    <td><input type="checkbox" class="bulk-item" value="{{ $blog->id }} "></td>
                                    <td><img class="w-80" src="{{ asset('assets/front/img/blog/' . $blog->image) }}" alt=""></td>
                                    <td>{{ $blog->title }}</td>
                                    <td>{{ $blog->bcategory ? ($blog->bcategory->name) : 'N/A' }}</td>
                                    <td>@if ($blog->status == 1)
