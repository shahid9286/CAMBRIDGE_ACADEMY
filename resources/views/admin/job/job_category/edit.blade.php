                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('admin.jcategory.index') }}" class="btn btn-primary btn-sm">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.jcategory.update', $jcategory->id) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="name" id="name"
                                            placeholder="{{ __('Name') }}" value="{{ $jcategory->name }}" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control form-control-sm" name="status" id="status">
                                            <option value="0" {{ $jcategory->status == '0' ? 'selected' : '' }}>
                                                {{ __('Unpublish') }}</option>
                                            <option value="1" {{ $jcategory->status == '1' ? 'selected' : '' }}>
                                                {{ __('Publish') }}</option>
                                        </select></div>
