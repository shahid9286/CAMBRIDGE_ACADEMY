...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.package-category.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="card card-primary card-outline mt-3">
                    <div class="card-header">
                        <h3 class="card-title text-primary"><i class="fas fa-plus-circle"></i> Add New Package Category</h3>
                    </div>
                    ...
                    <div class="card-body py-3">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="description" class="form-control form-control-sm summernote" rows="3">{{ old('description') }}</textarea>
                                @error('description')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <img class="mw-400 mb-3 show-img img-demo"
                                    src="{{ asset('assets/admin/uploads/package-category/icon/') }}" alt=""
                                    width="50px">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <img class="mw-400 mb-3 show-img img-demo"
                                    src="{{ asset('assets/admin/uploads/package-category/image/') }}" alt=""
                                    width="50px">
