    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li
                    class="nav-item {{ Route::currentRouteName() == 'admin.tempelate-file.add' || Route::currentRouteName() == 'admin.tempelate-file.index' ? 'menu-open' : '' }}">
                    <a href="" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.tempelate-file.index') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.tempelate-file.index' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('List') }}</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.tempelate-file.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.tempelate-file.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('add') }}</p>
                            </a>
                        </li>
                ...
                <li
                    ...
                    {{-- start Client --}}
                <li
                    class="nav-item {{ Route::currentRouteName() == 'admin.client.index' || Route::currentRouteName() == 'admin.client.add' ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.client.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.client.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.testimonial-section.index') }}"
                                ...
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('Testimonial Section List') }}</p>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('admin.testimonial-section.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.testimonial-section.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('Add New Testimonial Section') }}</p>
                            </a>
                        </li>
                ...
                <li
                    class="nav-item {{ Route::currentRouteName() == 'admin.feature.section.index' || Route::currentRouteName() == 'admin.feature.section.add' ? 'menu-open' : '' }}">
                    <a href="{{ route('admin.feature.section.index') }}" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.feature.section.index') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.feature.section.index' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __(' Section List') }}</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.feature.section.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.feature.section.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('Add Section') }}</p>
                            </a>
                        </li>
                ...
                {{-- Team Member --}}
                <li
                    class="nav-item {{ Route::currentRouteName() == 'admin.teams.index' || Route::currentRouteName() == 'admin.teams.add' ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.teams.index') }}"
                                ...
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('All Team Member') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.teams.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.teams.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('Add Team Member') }}</p>
                            </a>
                        </li>
                    </ul>
                    {{-- Team member End --}}
                ...
                {{-- package Category --}}
                <li
                    class="nav-item {{ Route::currentRouteName() == 'admin.package-category.index' || Route::currentRouteName() == 'admin.package-category.add' ? 'menu-open' : '' }}">
                    <a href="{{ route('admin.package-category.index') }}" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.package-category.index') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.package-category.index' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('All Package Category') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.package-category.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.package-category.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('Add Package Category') }}</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    {{-- Packages --}}
                <li
                    class="nav-item {{ Route::currentRouteName() == 'admin.package.index' || Route::currentRouteName() == 'admin.package.add' ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.package.index') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.package.index' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('All Packages') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.package.add') }}"
                                class="nav-link {{ Route::currentRouteName() == 'admin.package.add' ? 'active' : '' }}">
                                <i class="fas fa-circle nav-icon"></i>
                                <p>{{ __('Add Package') }}</p>
                            </a>
                        </li>
