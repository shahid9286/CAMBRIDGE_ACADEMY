                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="name" class="form-control form-control-sm" name="name" value="{{ old('name') }}" placeholder="{{ __('Enter Name') }}">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="email" id="email" class="form-control form-control-sm" name="email" value="{{ old('email') }}" placeholder="{{ __('Enter Email') }}">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="phone_no" class="form-control form-control-sm" name="phone_no" value="{{ old('phone_no') }}" placeholder="{{ __('Enter Phone Number') }}">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="subject" class="form-control form-control-sm" name="subject" value="{{ old('subject') }}" placeholder="{{ __('Enter Subject') }}">
                                    </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-12">
        <div class="input-group">
            ...
            <textarea id="enquiry_message" class="form-control form-control-sm form-control form-control-sm-sm" name="enquiry_message" rows="4" placeholder="{{ __('Enter Enquiry Message') }}">{{ old('enquiry_message') }}</textarea>
        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <input type="date" id="followup_date" class="form-control form-control-sm" name="followup_date" value="{{ old('followup_date') }}">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group">
                                        ...
                                        <select id="followup_type" name="followup_type" class="form-control form-control-sm">
...
<div class="form-group row">
    ...
    <div class="col-sm-12">
        <div class="input-group">
            ...
            <textarea id="remarks" class="form-control form-control-sm" name="remarks" rows="3" placeholder="{{ __('Enter Remarks') }}">{{ old('remarks') }}</textarea>
        </div>
