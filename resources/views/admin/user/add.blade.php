                                ...
                                <div class="col-lg-12">
                                    <form class="" action="{{ route('admin.user.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="email" name="email" placeholder="Enter Email" id="email"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="phone_no" id="phone_no" placeholder="Enter Phone No"
                                                            value="{{ old('phone_no') }}">
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm"
                                                            name="whatsapp_no" placeholder="Enter WhatsApp No" id="whatsapp_no"
                                            ...
                                            <div class="col-lg-12">
                                                <label for="image">{{ __('Upload icon') }}</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                ...
                                                <img class="mw-400 mt-1 mb-2 show-img img-demo"
                                                    src="{{ asset('assets/admin/uploads/user/') }}" alt="" width="120px">
                                                @if ($errors->has('icon'))
