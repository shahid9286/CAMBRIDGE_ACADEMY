...
<div class="bg-light p-2 rounded mb-3" style="overflow-x: auto; white-space: nowrap;">
    <ul class="nav nav-pills flex-row" style="min-width: max-content;">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.info-section.index', ['slug' => $slug]) }}" class="nav-link {{ Route::currentRouteName() == 'admin.info-section.index' || Route::currentRouteName() == 'admin.info-section.add' || Route::currentRouteName() == 'admin.info-section.edit' ? 'active' : '' }}">
                Infos
            </a>
        </li>
        <li class="nav-item">
