...
@section('title', ucwords(str_replace('-', ' ', $slug)) . ' | Feature List')
@section('content')
                ...
                {{-- content --}}
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Feature List') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('admin.feature.add', ['slug' => $slug]) }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg"></i> Add Feature</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
