...
@section('title', ucwords(str_replace('-', ' ', $slug)) . ' | Feature Images')
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header ">
                        <h3 class="card-title mt-1">{{ __('Feature Image List') }}</h3>
                       
                            <a href="{{ route('admin.feature_image.add', ['slug' => $slug]) }}" class="btn btn-sm btn-primary float-right ">
                            <i class="bi bi-plus-lg"></i> {{ __('Add Feature Image') }}
                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="deleteform" class="d-inline-block"
                                                action="{{ route('admin.feature_image.delete', $feature->id) }}"
                                                method="post">
                                                @csrf
