...
@section('title', ucwords(str_replace('-', ' ', $slug)) . ' | WhyChooseUs List')
@section('content')
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.why-choose-us.add', ['slug' => $slug]) }}"
                                class="btn btn-sm btn-primary"><i class="bi bi-plus-lg"></i> Add WhyChooseUs</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($whyUs as $key => $why)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($why->icon)
                                                <img src="{{ asset($why->icon) }}" width="50px" alt="Icon">
                                            @else
                                                N/A
                                            @endif
                                        </td>
