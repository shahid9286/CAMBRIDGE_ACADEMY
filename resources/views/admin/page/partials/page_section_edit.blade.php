        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.page.section.update', [$pageSection->id, 'slug' => $slug]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" id="title" class="form-control" name="title"
                                            placeholder="Enter Title" value="{{ old('title', $pageSection->title) }}"
                                            required>
                                    </div>
                                    @error('title')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" id="subtitle" class="form-control" name="subtitle"
                                            ...
                                            value="{{ old('subtitle', $pageSection->subtitle) }}" required>
                                    </div>
                                    @error('subtitle')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="number" id="order_no" class="form-control" name="order_no"
                                            ...
                                            value="{{ old('order_no', $pageSection->order_no) }}" required>
                                    </div>
                                    @error('order_no')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <select id="type" name="type" class="form-control" required>
                                            ...
                                            <option value="R-2-L"
                                                {{ old('type', $pageSection->type ?? '') == 'R-2-L' ? 'selected' : '' }}>
                                                Right To Left</option>
                                            <option value="L-2-R"
                                                {{ old('type', $pageSection->type ?? '') == 'L-2-R' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="description" class="form-control" name="description" placeholder="Enter Description"
                                        rows="6" required>{{ old('description', $pageSection->description) }}</textarea>
                                    @error('description')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <img class="mw-400 mb-3 show-img img-demo" src="{{ asset($pageSection->image) }}"
                                        alt="" width="120px">
