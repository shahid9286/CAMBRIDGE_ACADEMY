...
@section('title', ucwords(str_replace('-', ' ', $slug)) . ' | Add Feature Image')
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title mt-1">{{ __('Add Feature Image') }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
...
@enderror
    ...
    <div class="col-md-4">
        ...
        <div class="input-group input-group-sm">
            ...
            <input required value="{{ old('order_no') }}" type="number" class="form-control" id="order_no" placeholder="Enter Order Number" name="order_no">
        </div>
        @error('order_no')
            <p class="text-danger">{{ $message }}</p>
        @enderror
                                ...
                                <!-- Image -->
                                <div class="col-md-4">
                                     <label class="col-form-label col-form-label-sm" for="image">{{ __('Image') }} <span class="text-danger">*</span></label>
    <div class="input-group input-group-sm">
