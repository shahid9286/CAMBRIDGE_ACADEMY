                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline mt-2">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Add Course') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('admin.course.index') }}" class="btn btn-primary btn-sm">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="content" class="form-control form-control-sm summernote" id="content" rows="6"
                                            placeholder="{{ __('Course Content') }}">{{ old('content') }}</textarea>
