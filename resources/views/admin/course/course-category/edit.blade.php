...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form class="form-horizontal" action="{{ route('admin.course.category.update', $category->id) }}"
                            ...
                            <div class="col-md-12">
                                <div class="card card-primary card-outline mt-2">
                                    <div class="card-header">
                                        <h3 class="card-title mt-1">{{ __('Edit Course Category') }}</h3>
                                    ...
                                    <div class="card-body py-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <img class="mw-400 mb-3 show-img img-demo"
                                                    src="{{ asset('assets/admin/uploads/course_category/' . $category->thumbnail) }}" alt=""
                                                    width="50px">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @if ($category->icon)
                                                    <img class="mw-400 mb-3 show-img img-demo"
                                                        src="{{ asset('assets/admin/uploads/course_category/' . $category->icon) }}"
                                                        alt="" width="50px">
                                                @endif
                                                @error('icon')
                                                    <p class="text-danger">{{ $message }}</p>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @if ($category->banner_image)
                                                    <img class="mw-400 mb-3 show-img img-demo"
                                                        src="{{ asset('assets/admin/uploads/course_category/' . $category->banner_image) }}"
                                                        alt="" width="50px">
                                                @endif
                                                @error('banner_image')
                                                    <p class="text-danger">{{ $message }}</p>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary btn-sm">Update Course Category
                                            </button>
                                        </div>
                                    </div>
                                </div>
