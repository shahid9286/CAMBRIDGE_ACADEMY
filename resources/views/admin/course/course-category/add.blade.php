        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.course.category.store') }}" method="post"
                        enctype="multipart/form-data" id="courseCategoryForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary card-outline mt-2">
                                    <div class="card-header">
                                        <h3 class="card-title mt-1">{{ __('Add Course Category') }}</h3>
                                    </div>
                                    ...
                                    <div class="card-body py-3">
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary btn-sm">Add Course Category</button>
                                        </div>
