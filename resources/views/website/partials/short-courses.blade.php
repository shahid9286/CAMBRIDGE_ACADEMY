@php
    $short_courses = optional(
        App\Models\CourseCategory::where('slug', 'short-courses')->first()
    )->courses ?? collect();
@endphp
            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div class="site-heading text-center">
                        <h4 class="sub-title">Short Courses</h4>
                        <h2 class="title split-text">Discover Short Courses</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="visa-category-items wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="visa-course-carousel swiper">
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($short_courses->where('status', 1) as $course)
